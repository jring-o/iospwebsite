    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:items-center gap-3 pt-2 border-t border-rule">
        <Button
          type="submit"
          disabled={isPending}
          className="bg-royal text-paper hover:bg-royal-deep font-mono text-[11px] uppercase tracking-[0.18em] gap-2 px-6 py-3 h-auto transition-transform active:scale-[0.98]"
        >
          {isPending ? (
            <>
